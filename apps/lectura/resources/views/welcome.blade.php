...
<head>
    ...
    <title>{{ $institutionName }} | Lectura</title>
    <style>
        :root {
    ...
    <div class="shell">
        <section class="hero">
            <article class="card hero-copy">
                ...
                <p>
                    {{ $institutionName }} puede administrar estudiantes, textos y resultados de lectura
                ...
                <div class="actions">
                    <a class="button button-primary" href="{{ route('sso.login') }}">Ingresar con cuenta institucional</a>
