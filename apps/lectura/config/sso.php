...
return [
    ...
    'frontchannel_logout_client_key' => mb_strtolower(trim((string) env('SSO_FRONTCHANNEL_LOGOUT_CLIENT_KEY', 'lectura'))),
    ...
    'frontchannel_logout_next_hosts' => $csv(env(
        ...
        'localhost,127.0.0.1,oa-auth.test,oa-lectura.test,auth.iedagropivijay.edu.co,accounts.google.com,appengine.google.com'
    )),
