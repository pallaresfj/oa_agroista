...
class SsoController extends Controller
{
    ...
    public function login(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            Log::warning('SSO login redirect failed in lectura.', [
    ...
    public function callback(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            Log::warning('SSO callback failed in lectura.', [
                'message' => $exception->getMessage(),
            ]);
    ...
    public function completeSessionCheck(Request $request): RedirectResponse
    {
        ...
        if ($errorCode !== '') {
            Log::warning('Silent SSO session check returned error in lectura.', [
                'error' => $errorCode,
            ]);
        ...
        try {
            ...
            Log::warning('Silent SSO session check failed in lectura.', [
                'message' => $exception->getMessage(),
            ]);
    ...
    public function frontchannelLogout(Request $request): RedirectResponse
    {
        ...
        Log::warning('Invalid frontchannel logout request in lectura.', [
