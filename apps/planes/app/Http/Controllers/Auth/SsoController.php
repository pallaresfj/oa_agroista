...
class SsoController extends Controller
{
    ...
    public function callback(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            Log::warning('SSO callback failed in planes.', [
    ...
    public function completeSessionCheck(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            Log::warning('Silent SSO session check failed in planes.', [
                'message' => $exception->getMessage(),
            ]);
        ...
        if ($institutionCode !== '') {
            $user->institution_code = $institutionCode;
        }
    ...
    public function frontchannelLogout(Request $request): RedirectResponse
    {
        ...
        $expectedClient = mb_strtolower(trim((string) config('sso.frontchannel_logout_client_key', 'gestionplanes')));
        ...
        Log::warning('Invalid frontchannel logout request in gestionplanes.', [
