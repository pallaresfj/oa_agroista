...
return new class extends Migration
{
    ...
    protected function ensureRolesTable(): void
    {
        ...
        DB::table('roles')
            ...
            ->orderBy('id')
            ->chunk(250, function ($roles): void {
                foreach ($roles as $role) {
                    DB::table('roles')
                        ->where('id', $role->id)
                        ->update(['name' => 'legacy_role_' . $role->id]);
                }
            });
    }

    protected function ensurePermissionsTable(): void
    {
    ...
    protected function ensureSpatiePivotTables(): void
    {
